...
<head>
    ...
    <title>Services - Tahneem Movers</title>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-4 col-lg-4">
                            <div class="logo">
                                <a href="index">
                                    <img src="img/tahneem-logo_non-bg.png" style="width: 30%; height: auto;">
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="#">Moving Services<i class="ti-angle-down"></i></a>
                                                <ul class="submenu">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="single_service">
                        <div class="thumb">
                            <img src="img/services/home_moving.png" alt="Home Moving Services" loading="lazy">
                        </div>
                        <div class="service_info">
                            <h3><a href="service_details">Home Moving Services</a></h3>
                            <p>
                               We
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single_service">
                        <div class="thumb">
                            <img src="img/services/office_relocation.png" alt="Office Relocation Services" loading="lazy">
                        </div>
                        <div class="service_info">
                            <h3><a href="service_details">Office Relocation Services</a></h3>
                            <p>
                               We
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single_service">
                        ...
                        <div class="service_info">
                            <h3><a href="service_details">Warehousing Services</a></h3>
                            <p>
                               We
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="single_service">
                        <div class="thumb">
                            <img src="img/services/packaging.png" alt="Packaging Services" loading="lazy">
                        </div>
                        <div class="service_info">
                            <h3><a href="service_details">Packaging Services</a></h3>
                            <p>
                               We
                                provide secure and efficient
                                warehousing solutions tailored to meet
