...
<head>
    ...
    <title>About Us - Tahneem Movers</title>
                ...
                <div class="row  align-items-center">
                    <div class="col-xl-5 col-lg-5 col-md-6">
                        <div class="about_image">
                            <img src="img/banner/portfolio-banner.png" style="height: 100%;" alt="">
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-md-6">
                        <div class="action_heading">
                            ...
                            <p>Tahneem Movers Kenya are trained to provide you with the very best advice and service from the moment you first make contact with us.</p>
                        </div>
                    </div>
                    <div class="col-xl-5 col-md-6">
                        <div class="call_add_action">
                            <a href="#" class="boxed-btn3">+254 712 345 678</a>
                        </div>
                    </div>
                </div>
            </div>
